...
export default function ForecastCard() {
  ...
  return (
    <div className="mt-4 bg-slate-900/60 border border-slate-800 rounded-xl overflow-hidden shadow-xl">
      {/* Header */}
      <div className="px-4 pt-4 pb-3 border-b border-slate-800 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5 bg-slate-800/60 rounded-full px-2.5 py-1 border border-slate-700/50">
      ...
      {loading ? (
        <div className="px-4 py-8 flex flex-col items-center gap-2">
          <div className="w-6 h-6 rounded-full border-2 border-slate-700 border-t-sky-500 animate-spin" />
        ...
        <>
          ...
          <div className="px-3 py-2.5 flex flex-wrap gap-1.5 border-b border-slate-800/60">
            {reports.map((r) => {
