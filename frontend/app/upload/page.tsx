...
/**
 * UploadPage Component — Redesigned UI
 *
 * Visual changes from original:
 * - Three-layer depth: page bg (#0d0f12) → section cards (#131720) → inner panels (#0d1118)
 * - Upload zone has a radial gradient glow, icon wrapper, and format pills
 * - OCR cards use Tabler icons + DM Mono values
 * - Risk badge is color-coded (HIGH/MEDIUM/LOW/NO DATA) without dark: prefix hacks
 * - Confidence card includes anemia + hypertension sub-metrics grid
 * - Prediction cards each have a colored icon label
 */
...
export default function UploadPage() {
  ...
  // Risk badge styling — three variants, no dark: prefix needed
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="bg-[#131720] border border-[#1e2535] rounded-2xl p-6">
        ...
        <div className="relative overflow-hidden border-2 border-dashed border-[#1e3a5a] rounded-2xl p-12 text-center bg-linear-to-b from-[#0f1820] to-[#0d1118]">
          ...
          {/* Icon */}
          <div className="relative w-14 h-14 mx-auto mb-4 rounded-2xl bg-[#0f1f32] border border-[#1e3a5a] flex items-center justify-content-center justify-center">
